...
/*
print(getMapInfo2(mp));
mpm := MedialOfMap(mp);
print(getMapInfo2(mpm));
ok, mpdm := deMedialize(mpm);
if not ok then print("PROBLEM!!!"); end if;
print(getMapInfo2(mpdm));
*/
/*
ok, mpdm := deMedialize(mp);
print(getMapSymbol(mp));
print(getMapInfo2(mp));
print(getMapInfo2(mpdm));
*/
//print(orbitsOfFaces(G, stab, norm, fmap, b, gens));

print("Type 1");
demedialization2ToFile("type1.csv", "1", 1, #t1olst);
/*
print("Type 2");
demedialization2ToFile("type2.csv", "2", 1, #t2lst);
print("Type 2ex");
demedialization2ToFile("type2ex.csv", "2ex", 1, #t2exlst);
print("Type 3");
demedialization2ToFile("type3.csv", "3", 1, #t3lst);
print("Type 4");
demedialization2ToFile("type4.csv", "4", 1, #t4lst);
print("Type 5");
demedialization2ToFile("type5.csv", "5", 1, #t5lst);
*/